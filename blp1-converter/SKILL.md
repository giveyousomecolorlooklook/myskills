...
```powershell
python C:\Users\admin\.codex\skills\blp1-converter\scripts\convert_blp1.py input.blp output.png
python C:\Users\admin\.codex\skills\blp1-converter\scripts\convert_blp1.py input.png output.blp
python C:\Users\admin\.codex\skills\blp1-converter\scripts\convert_blp1.py input.png output.blp --quality 95
```
...
- Preserve 8-bit alpha by appending an alpha plane after each JPEG mip payload when the source PNG has transparency.
...
Do not claim byte-identical `PNG -> BLP -> PNG` output. PNG file bytes include encoder choices and chunks that are not represented in normal Warcraft III BLP1 image data. JPEG-compressed BLP1 is also lossy, so validate visual quality or pixel error rather than file-byte equality.
...
```powershell
python C:\Users\admin\.codex\skills\blp1-converter\scripts\convert_blp1.py source.blp source.png
python C:\Users\admin\.codex\skills\blp1-converter\scripts\convert_blp1.py source.png roundtrip.blp
python C:\Users\admin\.codex\skills\blp1-converter\scripts\convert_blp1.py roundtrip.blp roundtrip.png
```
